...
model_urls = {
    ...
    #'resnet101': '/home/wangyude/.cache/torch/hub/checkpoints/resnet101s-03a0f310.pth',
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, dilated=False, multi_grid=False,
        ...
        self.layernorm = nn.LayerNorm(self.inplanes)
    ...
    def forward(self, x, return_embed=False):
        ...
        l4 = self.layer4(l3)
        if return_embed:
            embed = x.flatten(2).transpose(1,2)
            embed = self.layernorm(embed)
            return [l1, l2, l3, l4], embed
        else:
            return [l1, l2, l3, l4]
...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        #old_dict = torch.load(model_urls['resnet50'])
